...
def findPattern(
    ...
    for char in truePattern[:-1]:
        ...
        stringSeenToStateDict[stringSoFar] = State(
            name + "_recog_pattern_" + stringSoFar
        )
    ...
    for char in truePattern:
        ...
        for symbol in alphabet:
            ...
            if newString == truePattern:
                ...
                stateSoFar.setNextState(
                    symbol, stringSeenToStateDict[getBestPrefix(pattern, newString)]
                )
