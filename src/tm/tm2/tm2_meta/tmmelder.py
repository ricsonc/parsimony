...
if __name__ == "__main__":
    ...
    inMachine = tmsim.SingleTapeTuringMachine(
        "../tm2_files/" + sys.argv[1] + ".tm2", alphabetMSToTS()
    )
    outMachine = tmsim.SingleTapeTuringMachine(
        "../tm2_files/" + sys.argv[2] + ".tm2", alphabetMSToTS()
    )
    ...
    convertStatesToString(
        inMachine.listOfRealStates + outMachine.listOfRealStates,
